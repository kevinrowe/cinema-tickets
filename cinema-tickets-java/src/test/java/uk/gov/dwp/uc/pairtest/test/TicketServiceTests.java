...
public class TicketServiceTests {
	...
	public void noAdultTicketThrowsException() {
		Exception exception = assertThrows(InvalidPurchaseException.class, () -> {
			ticketService.purchaseTickets(accountId, new TicketTypeRequest(Type.CHILD, 1), new TicketTypeRequest(Type.INFANT, 1));
		});
	...
	private static Stream<Arguments> getPaymentAmountTestData() {
		return Stream.of(
			Arguments.of(new TicketTypeRequest[] { new TicketTypeRequest(Type.ADULT, 1) }, 20),
			Arguments.of(new TicketTypeRequest[] { new TicketTypeRequest(Type.ADULT, 3) }, 60),
			Arguments.of(new TicketTypeRequest[] { new TicketTypeRequest(Type.ADULT, 1), new TicketTypeRequest(Type.CHILD, 1) }, 30),
			Arguments.of(new TicketTypeRequest[] { new TicketTypeRequest(Type.ADULT, 1), new TicketTypeRequest(Type.INFANT, 1) }, 20),
			Arguments.of(new TicketTypeRequest[] { new TicketTypeRequest(Type.ADULT, 2), new TicketTypeRequest(Type.CHILD, 2) }, 60),
			Arguments.of(new TicketTypeRequest[] { new TicketTypeRequest(Type.ADULT, 2), new TicketTypeRequest(Type.INFANT, 2) }, 40)
		);
	}
	
	private static Stream<Arguments> getSeatNumberTestData() {
		return Stream.of(
			Arguments.of(new TicketTypeRequest[] { new TicketTypeRequest(Type.ADULT, 1) }, 1),
			Arguments.of(new TicketTypeRequest[] { new TicketTypeRequest(Type.ADULT, 3) }, 3),
			Arguments.of(new TicketTypeRequest[] { new TicketTypeRequest(Type.ADULT, 1), new TicketTypeRequest(Type.CHILD, 1) }, 2),
			Arguments.of(new TicketTypeRequest[] { new TicketTypeRequest(Type.ADULT, 1), new TicketTypeRequest(Type.INFANT, 1) }, 1),
			Arguments.of(new TicketTypeRequest[] { new TicketTypeRequest(Type.ADULT, 2), new TicketTypeRequest(Type.CHILD, 2) }, 4),
			Arguments.of(new TicketTypeRequest[] { new TicketTypeRequest(Type.ADULT, 2), new TicketTypeRequest(Type.INFANT, 2) }, 2)
		);
	}
}
